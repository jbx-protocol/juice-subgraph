...
import { JB721Delegate3_3 as JB721Delegate3_3DataSource } from "../../../generated/templates";
import { JBTiered721DelegateStore3_3 } from "../../../generated/JBTiered721DelegateDeployer3_3/JBTiered721DelegateStore3_3";
import { JB721Delegate3_3 } from "../../../generated/JBTiered721DelegateDeployer3_3/JB721Delegate3_3";
...
export function handleDelegateDeployed(event: DelegateDeployed): void {
  ...
  JB721Delegate3_3DataSource.createWithContext(
    address,
  ...
  if (nameCall.reverted) {
    log.error(
      "[jbTiered721DelegateDeployer_3_3:handleDelegateDeployed] name() reverted for {}",
      [address.toHexString()]
    );
    return;
  }
  ...
  if (symbolCall.reverted) {
    log.error(
      "[jbTiered721DelegateDeployer_3_3:handleDelegateDeployed] symbol() reverted for {}",
      [address.toHexString()]
    );
    return;
  }
  ...
  if (!address_shared_jbTiered721DelegateStore3_3) {
    log.error(
      "[jbTiered721DelegateDeployer_3_3:handleDelegateDeployed] missing address_shared_jbTiered721DelegateStore3_3",
      []
    );
    return;
  }
  ...
  if (maxTierCall.reverted) {
    ...
    log.error(
      "[jbTiered721DelegateDeployer_3_3:handleDelegateDeployed] maxTier() reverted for {}",
      [address.toHexString()]
    );
    return;
  }
