...
import { JB721Delegate3_3 } from "../../../generated/templates/JB721Delegate3_3/JB721Delegate3_3";
...
export function handleDelegateDeployed(event: DelegateDeployed): void {
  ...
  if (!address_shared_jbTiered721DelegateStore3_3) {
    log.error(
      "[jb721_v1:handleTransfer] missing address_shared_jbTiered721DelegateStore3_3",
      []
    );
    return;
  }
