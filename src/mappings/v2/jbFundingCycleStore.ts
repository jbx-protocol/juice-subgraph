...
export function handleConfigure(event: Configure): void {
  ...
  if (configureEvent) {
    ...
    configureEvent.redemptionRate =
      MAX_REDEMPTION_RATE - u16((event.params.metadata >> 40).toI32());
    configureEvent.ballotRedemptionRate =
      MAX_REDEMPTION_RATE - u16((event.params.metadata >> 56).toI32());
    configureEvent.payPaused = bool(
      ((event.params.metadata >> 72) & BigIntOne).toI32()
    );
    configureEvent.distributionsPaused = bool(
      ((event.params.metadata >> 73) & BigIntOne).toI32()
    );
    configureEvent.redeemPaused = bool(
      ((event.params.metadata >> 74) & BigIntOne).toI32()
    );
    configureEvent.burnPaused = bool(
      ((event.params.metadata >> 75) & BigIntOne).toI32()
    );
    configureEvent.mintingAllowed = bool(
      ((event.params.metadata >> 76) & BigIntOne).toI32()
    );
    configureEvent.terminalMigrationAllowed = bool(
      ((event.params.metadata >> 77) & BigIntOne).toI32()
    );
    configureEvent.controllerMigrationAllowed = bool(
      ((event.params.metadata >> 78) & BigIntOne).toI32()
    );
    configureEvent.shouldHoldFees = bool(
      ((event.params.metadata >> 79) & BigIntOne).toI32()
    );
    configureEvent.preferClaimedTokenOverride = bool(
      ((event.params.metadata >> 80) & BigIntOne).toI32()
    );
    configureEvent.useTotalOverflowForRedemptions = bool(
      ((event.params.metadata >> 81) & BigIntOne).toI32()
    );
    configureEvent.useDataSourceForPay = bool(
      ((event.params.metadata >> 82) & BigIntOne).toI32()
    );
    configureEvent.useDataSourceForRedeem = bool(
      ((event.params.metadata >> 83) & BigIntOne).toI32()
    );
